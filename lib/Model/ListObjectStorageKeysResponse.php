...
/**
 * ListObjectStorageKeysResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ListObjectStorageKeysResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ListObjectStorageKeysResponse';
    ...
    protected static $swaggerTypes = [
        'keys' => '\Swagger\Client\Model\ObjectStorageKey[]',
        'page_number' => 'int',
        'page_size' => 'int',
        'total_count' => 'int'
    ];
     ...
     * Sets keys
     *
     * @param \Swagger\Client\Model\ObjectStorageKey[] $keys keys
     *
     * @return $this
     */
